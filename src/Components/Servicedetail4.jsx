...
export default function Servicedetail4() {
  ...
  <div className='  flex justify-center flex-col w-full  items-center py-10  gap-6'>
        <h2 className=' text-white font-bold text-5xl'>Our Project</h2>
    ...
    <div className="flex flex-wrap justify-center ">
      ...
      <div className="max-w-xs w-full sm:max-w-sm sm:w-1/2 lg:w-1/3 p-4 relative">
        ...
        <img src="../asets/img/Card-Image_tbal7g.webp" alt="" />
          ...
          <div className="black-overlay absolute bottom-3 left-4 w-[90%] flex justify-between items-center h-12 group-hover:h-20 bg-black opacity-100 transition-all duration-300 pl-4 pt-2 ">
            <h2 className=' text-white text-xl'>MintStargram Tech</h2>
    <button className=' hidden  group-hover:block xl:h-8 lg:h-6 md:h-4  xl:w-32 lg:w-44 md:w-44 text-[12px]  w-36 bg-black font-bold text-white'>View Details</button>
